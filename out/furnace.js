...
(function() {
  define('validator/Validator',['validator/ValidatorError', 'Util'], function(ValidatorError, Util) {
    ...
    var Validator, checkCollisions, validateColorComponent, validateColors, validateEnterRules, validateGive, validateHeal, validateHurt, validateInInventoryItem, validateInTerrainItem, validateLeaveRules, validateLegend, validateLevels, validateNearRules, validateObjects, validateOutTerrainItem, validateParam, validatePlayer, validateSets, validateSprites, validateTeleport, validateUseRules;
    Validator = {};
...
// Generated by CoffeeScript 1.8.0
(function() {
  define('main-editor',['tokenizer/Tokenizer', 'parser/Parser', 'validator/Validator', 'extractor/ValueExtractor', 'import-export/ToPng'], function(Tokenizer, Parser, Validator, ValueExtractor, ToPng) {
    
    var baseUrl, compile, emit, errorLine, exportAsPng, inWorldEditor, mainEventHandlers, mainListener, onChange, originUrl, parse, requestSource, run, setUrl, setupComm, setupEditors, setupGui;
    baseUrl = 'http://madflame991.github.io/furnace-engine/src/index.html';
    errorLine = null;
    inWorldEditor = null;
    onChange = function() {
      return parse(inWorldEditor.getValue());
    };
    ...
    mainEventHandlers = {
      'source': function(data) {
        return inWorldEditor.setValue(data.source);
      }
    };
