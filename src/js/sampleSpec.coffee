...
snow -> snow-trampled
snow-rad -> snow-rad-trampled ; hurt 1 ; message "This heavily        radiated snow hurts"
...
win -> floor ; message "I have found a stash to last a lifetime"

USERULES

ladder-down1 eye -> ladder-down1 ; message "Ladder goes to the  surface"
ladder-down2 eye -> ladder-down2 ; message "Ladder goes to the  surface"
ladder-up1 eye -> ladder-up1 ; message "Ladder to           underground"
ladder-up2 eye -> ladder-up2 ; message "Ladder to           underground"
...
jane eye -> jane ; message "Jane"
mr-white1 eye -> mr-white1 ; message "Mr White looks      thirsty"
...
bottle-rad eye -> bottle-rad ; message "Bottle of irradiated water"
...
snow-rad-trampled eye -> snow-rad-trampled ; message "Irradiated trampled snow"
tree eye -> tree ; message "Dead tree"
radio1-unpowered eye -> radio1-unpowered ; message "Radio unpowered"
radio1-powered eye -> radio1-powered ; message "Radio there is a    faint signal"
radio2-unpowered eye -> radio2-unpowered ; message "Radio unpowered"
radio2-powered eye -> radio2-powered ; message "Radio the signal is stronger here"
...
drill-unpowered battery -> floor ; give 1 drill-powered ; consume
radio1-unpowered battery -> radio1-powered ; consume ; message "You can hear a faint distress signal"
radio2-unpowered battery -> radio2-powered ; consume ; message "You hear the same signal, but stronger"

floor bottle-water -> floor ; heal 1
mr-white1 bottle-water -> mr-white2 ; give 1 key , 1 bottle-empty ; consume ; message "Thanks! Here take this key I found! I don't know what it opens but maybe you will find out"
mr-white1 bottle-rad -> mr-white1 ; message "This water is not pure"
